...
enum class Anime4KShader(@StringRes val titleRes: Int) {
  None(R.string.pref_anime4k_none),
  ModeAFast(R.string.pref_anime4k_mode_a_fast),
  ModeAHQ(R.string.pref_anime4k_mode_a_hq),
  ModeBFast(R.string.pref_anime4k_mode_b_fast),
  ModeBHQ(R.string.pref_anime4k_mode_b_hq),
  ModeCFast(R.string.pref_anime4k_mode_c_fast),
  ModeCHQ(R.string.pref_anime4k_mode_c_hq),
}
