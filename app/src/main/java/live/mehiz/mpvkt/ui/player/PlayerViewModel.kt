...
class PlayerViewModel(
  ...
  // 超分档位状态：0=关闭，1=质量，2=效率
  private val _superResLevel = MutableStateFlow(0)
  val superResLevel = _superResLevel.asStateFlow()
  fun setSuperResLevel(level: Int) {
    _superResLevel.value = level
  }
